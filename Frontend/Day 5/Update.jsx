                        ...
                        <div className=''>
                            ...
                            <form className='event-detailsu'>
                                ...
                                <div className='event-itemsu'>
                                    ...
                                    <input className="eb-inputu" type="text" placeholder="Enter event type"/>
                                    <label className='eb-labelu'>Event Description</label>
                                    <input className="eb-inputu" type="text" placeholder="Enter event Description"  required/>
                                    <label className='eb-labelu'>Charges</label>
                                    <input className="eb-inputu" type="text" placeholder="Enter the charges"  required/>
                                </div>
                                <div  className='event-itemsu'>
                                <label className='eb-labelu'>Event Package</label>
                                    <input className="eb-inputu" type="text" placeholder="Enter package" required />
                                    <label className='eb-labelu'>Participants Count</label>
                                    <input className="eb-inputu" type="text" placeholder="Enter the count"  required/>
                                </div>
                                </div>
                                <div  className='event-itemsu'>
